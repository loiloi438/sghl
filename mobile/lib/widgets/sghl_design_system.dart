...
class SghlDashboardHero extends StatelessWidget {
  const SghlDashboardHero({super.key, required this.prenom, this.trailing});
                  ...
                  Badge(
                    ...
                    child: Icon(
                      ...
                      color: lightBar
                          ...
                          : (selected ? Colors.white : SghlColors.mutedDark),
                      size: compact ? 26 : 23,
                    ),
                  ),
                  if (!compact && item.label != null) ...[
                    const SizedBox(height: 2),
                    Text(
                      item.label!,
                      maxLines: 1,
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          _bubble(Icons.calendar_month_rounded, 52, -10, 30, SghlColors.gold),
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: SghlColors.medicalBlue.withValues(
